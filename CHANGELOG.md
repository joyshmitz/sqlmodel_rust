...
**Workspace version bump** with dependency updates and FrankenSQLite compatibility fixes. No new GitHub Release yet.

Bump commit: [`21b872d`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/21b872df6696f25245feeafa5f0f526cd774aca3)

### Changed

- Updated `asupersync` dependency to 0.2.9 and `frankensqlite` to 0.1.2.

### Fixed — FrankenSQLite driver

- Adapted value conversions to accommodate `SqliteValue`'s new `Arc<str>` / `Arc<[u8]>` inner types ([`ac1ddb1`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/ac1ddb1bcff52edf677856204ff08a9d7053cc36)).
- Used `to_string()` instead of `clone()` for `SqliteValue::Text` to satisfy the new API ([`3a3f078`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/3a3f0783a9869c5fce12d5d7530a69088016958a)).
- Implemented proper `close_sync` for `FrankenConnection` so connections clean up correctly ([`db73fb4`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/db73fb4c7a6e22b76f474a63406ed49d754cbad2)).

### Fixed — PostgreSQL driver

- Prevented a hang in `PgAsyncConnection` by using `push()` instead of `feed()` when sending messages ([`f82770e`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/f82770e57407afcfc1f659d00799b01670b9780c)).
...
- Removed leftover `eprintln!` debug statements from the FrankenSQLite connection layer ([`97e6f32`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/97e6f32d2ef88c5aed2f9e452d1d86e0e91fba6e)).
...
- Fixed auto-increment primary-key schema generation during dependency upgrade ([`6a3376b`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/6a3376b24ed41ad7f1e2bb0d24980a5ab97e5aeb)).

---

## [0.2.0] — 2026-02-15 (GitHub Release)

**First tagged release.** 11 publishable crates providing an intuitive, type-safe SQL toolkit for Rust, published to crates.io.
...
- `sqlmodel-frankensqlite` — Pure-Rust SQLite driver built on FrankenSQLite. Depends on path-only `frankensqlite` crates not yet on crates.io; excluded from the release publish.

### Added since 0.1.1 — Table inheritance

- **Single-table inheritance (STI):** discriminator column support for STI base models, discriminator filtering automatically applied to SELECT queries ([`4f3de74`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/4f3de7491377bb36dc46612cabee2efff9bf6fbc), [`86143a8`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/86143a8c1e2a3aef2470f79bb6e0a47252353b77)).
- **Joined-table inheritance:** parent field embedding, automatic JOINs in all SELECT/INSERT/UPDATE/DELETE paths, polymorphic queries, and `insert_many` support ([`f76f999`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/f76f999eade496ca1f8bb840e60242f6a020717e), [`4bcf5f1`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/4bcf5f13b161ef736f34de0829bf5244aabe5472), [`d9ed0a9`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/d9ed0a976c2fc710b462f93b02588c7e2f1807e9)).
- Explicit DML semantics for joined inheritance so inserts/updates route to the correct base+child tables.

### Added since 0.1.1 — Session & ORM features
...
### Added since 0.1.1 — Schema & introspection
...
- Driver introspection parity tests for Postgres, MySQL, and SQLite ([`fb30cc9`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/fb30cc9887c8d6795ff7fedb0eee0197228a6023)).
...
### Added since 0.1.1 — SQLite online backup

- SQLite online backup API support added to the SQLite driver ([`982b7f4`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/982b7f40455e8f4c1f253ef02ab4539ea8540de9)).

### Added since 0.1.1 — FrankenSQLite driver (experimental)

- New `sqlmodel-frankensqlite` crate: pure-Rust SQLite driver via FrankenSQLite ([`cd11cdd`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/cd11cddb5de24997b6d917c03cfb2c094ab80863)).
- `RETURNING *` column name resolution ([`74bbad7`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/74bbad7348d4dde5e65323d34631793c5d33103e)).
- Comprehensive test suite for `BEGIN CONCURRENT`, transactions, and the `Connection` trait ([`26df685`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/26df685665367707cb8b1e4ed3a808f9d50f0401)).
...
- Dialect propagated correctly in `EXISTS` / lateral subqueries ([`80df00b`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/80df00bd8bb673ea11775eb9e64df075ca624776)).
...
## 0.1.0 — 2026-01-17 through 2026-02-04 (Initial development, no tag or release)

**Ground-up implementation** of the entire SQLModel Rust workspace. Development began 2026-01-17 with commit [`37e6a0c`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/37e6a0c8e2384edf9475185f5d20bbe7c13867e2) and reached feature-complete status before the 0.1.1 publish-preparation bump.

### Core framework (sqlmodel-core)

- `Model` trait with `FieldInfo`, `Value`, `Row`, `Connection`, and `Error` types.
- Automatic Rust-to-SQL type mapping (i8..i64, f32/f64, bool, String, Vec<u8>, chrono, uuid).
...
- `From`/`TryFrom` implementations for `Vec<T>` on `Value` type ([`ad98aba`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/ad98aba)).
- Precision loss detection for f32/f64 conversions; silent u64-to-i64 overflow prevention ([`a441c90`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/a441c90d93c64c313025945ac54aa3b28f8b5434), [`1a31f82`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/1a31f82e3f468d38a27f0ab31d4d590d38c0ab2b)).
- PostgreSQL ARRAY type support ([`755000d`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/755000d)).
- Dynamic model creation at runtime ([`a1f9853`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/a1f9853)).
- Hybrid properties (computed fields) ([`4aecd67`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/4aecd67)).
- Attribute change events ([`5c039a4`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/5c039a4)).
- Runtime validation module with regex caching ([`b701950`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/b701950)).
- Relationship metadata types and `Related<T>` wrapper ([`0f60318`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/0f60318), [`aaf5ceb`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/aaf5ceb)).

### Proc macros (sqlmodel-macros)
...
- `on_delete` / `on_update` foreign-key cascade attributes ([`f50b704`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/f50b704)).
- `#[derive(Validate)]` macro for field-level validation ([`254f22e`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/254f22e)).
- `discriminator` attribute for union/polymorphic type support ([`67801c5`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/67801c5)).
- `shard_key` attribute for horizontal sharding ([`3daa9ad`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/3daa9ad)).
...
- Relationship attribute parsing ([`655cd58`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/655fd58)).
...
- NULL-safe comparisons, CAST, and string pattern helpers ([`b7d8ea6`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/b7d8ea6)).
- Dialect-aware identifier quoting throughout ([`635a248`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/635a248)).

### Schema & migrations (sqlmodel-schema)

- DDL generation from `Model` definitions, schema extraction ([`b64bfd2`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/b64bfd2)).
- Schema diff engine for automatic migration generation ([`8f5ff2b`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/8f5ff2b)).
- Migration file generator ([`16064f4`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/16064f4)).
- DDL generation from schema operations ([`a16984f`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/655fd58)).
- `sql_type` attribute wired into DDL override ([`6bfc59a`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/6bfc59a), [`4ba14c8`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/4ba14c8)).
- Schema introspection for all three database types ([`3b83df7`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/3b83df7)).
- Shared `quote_ident` / `sanitize_identifier` used across schema and session ([`a7da01d`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/a7da01d97a54c3e296a9395a0b22f6cea533a907)).

### Session / unit of work (sqlmodel-session)

- `Session` with identity map and unit-of-work pattern ([`c511768`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/c511768)).
- Change tracking and dirty detection ([`61b4a11`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/61b4a11)).
- `Session::flush()` with operation ordering and batching ([`030dfd4`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/030dfd4), [`0a22269`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/0a22269)).
- Many-to-many relationship flush with `LinkTableOp` ([`3aa316a`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/3aa316a), [`4c7c242`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/4c7c242)).
- `Lazy<T>` wrapper type for deferred loading with `Session::load_lazy` / `load_many` ([`3ba0948`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/3ba0948), [`1d28c1a`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/1d28c1a)).
- Eager loading infrastructure with hydration and tracing ([`2a97f40`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/2a97f40), [`c65ef18`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/c65ef18)).
- Bulk insert and bulk update operations ([`4b9fecd`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/4b9fecd)).
- N+1 detection with `N1DetectionScope` RAII guard ([`afcf3aa`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/afcf3aa), [`72c29e3`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/72c29e3)).
- DECIMAL precision/scale support ([`72c29e3`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/72c29e3)).
...
- `PoolErrorKind::Poisoned` variant for mutex poison scenarios ([`31d1603`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/31d1603)).
- Read replica routing ([`3246849`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/3246849)).
...
- Async connection with `Connection` trait ([`29570fc`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/29570fc)).
...
- TLS/SSL configuration and handshake ([`6886daf`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/6886daf35bdfdd0a209ac4b3568d866975b50679), [`9b2c4ae`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/9b2c4ae)).
...
- CONCAT operator compatibility ([`e1822e9`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/e1822e99513ea162d66c1f2791d5251b939390f9)).
...
- `SessionBuilder` with console integration.
...
- Architecture-portable hash and improved change tracking diagnostics ([`4fd6648`](https://github.com/Dicklesworthstone/sqlmodel_rust/commit/4fd6648)).
...
- Existing SQLModel Structure (behavior specification from Python).
- Feature Parity Tracker (`FEATURE_PARITY.md`) reaching 92%+ coverage.
- Console User Guide and Agent Compatibility Guide.
